...
### Description: contains 'Poseclass' class. containing 'PoseID' function which returns the current user pose as a string when given the results from pose.process.
